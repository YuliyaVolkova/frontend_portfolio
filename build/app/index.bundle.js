  ...
  new _vue2.default({
    ...
    methods: {
      ...
      validateForm: function validateForm(e) {
        ...
        if (this.wrongLogin || this.wrongPassword || this.wrongCheckbox || this.wrongRadio) e.preventDefault();
      }
    }
  });
};
