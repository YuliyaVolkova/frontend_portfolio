...
var _blur = __webpack_require__(44);

var _blur2 = _interopRequireDefault(_blur);

var _scroll_works = __webpack_require__(45);

var _scroll_works2 = _interopRequireDefault(_scroll_works);
...
///*-------------------------------
var init = function init() {
  _scroll_works2.default.handler();
  _cHamburger2.default.handler();
  __webpack_require__(46);
  _blur2.default.handler();
...
var dataWorks = [{ id: '0001',
  title: 'Сайт школы онлайн Образования',
  technologies: 'HTMl , CSS, JAVASCRIPT',
  url: '../assets/images/content/work-1.png' }, { id: '0002',
  title: 'Работа_2',
  technologies: 'HTMl , Sass, JAVASCRIPT',
  url: '../assets/images/content/work-2.png' }, { id: '0003',
  title: 'Работа_3',
  technologies: 'Pug , Sass, JAVASCRIPT',
  url: '../assets/images/content/work-3.png' }, { id: '0004',
  title: 'Работа_4',
  technologies: 'Pug , Sass, JAVASCRIPT, Vue',
  url: '../assets/images/content/work-4.png' }];
var slider = new _vue2.default({
  el: '#worksSlider',
  data: {
    dataArr: dataWorks,
  ...
  methods: {
    move: function move(amount) {
      ...
      var newIndex = this.active + amount;
...
var validateFormFeed = new _vue2.default({
  el: '#feeds-form',
  data: {
    name: { value: '',
      error: ''
